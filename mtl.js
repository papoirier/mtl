$(document).ready(function() {
	...
	$.getJSON("data.json", function(data) {	
		...
		// section title
		$("#eat > .container").append("<div class=\"title row\"><div class=\"col-lg-12\"><h1>" + data.eat.title);
		...
		$("#eat > .container > .breakfast").append("<div class=\"section_title row\"><div class=\"col-lg-12\"><h3>" + data.eat.cuisines.breakfast.region);
		$("#eat > .container > .breakfast > .section_title > .col-lg-12").append("<h4>" + data.eat.cuisines.breakfast.description);
		...
		$("#eat > .container > .dinner").append("<div class=\"section_title row\"><div class=\"col-lg-12\"><h3>" + data.eat.cuisines.dinner.region);
		$("#eat > .container > .dinner > .section_title > .col-lg-12").append("<h4>" + data.eat.cuisines.dinner.description);
		...
		$("#eat > .container > .any_hour").append("<div class=\"section_title row\"><div class=\"col-lg-12\"><h3>" + data.eat.cuisines.any_hour.region);
		$("#eat > .container > .any_hour > .section_title > .col-lg-12").append("<h4>" + data.eat.cuisines.any_hour.description);
		...
		// section title
		$("#stay > .container").append("<div class=\"title row\"><div class=\"col-lg-12\"><h1>" + data.stay.title);
		$("#stay > .container").append("<div class=\"title row\"><div class=\"col-lg-12\"><h4>" + data.stay.description);
		
		// neighborhoods
		$("#stay > .container").append("<div class=\"neighbourhoods\">");
		
		function hoodData(rowNumber) {
			$("#stay > .container > .neighbourhoods > ." + rowNumber).append("<div class=\"col-lg-4 block" + i + "\">");
		...
		$("#stay > .container > .hotels").append("<div class=\"title row\"><div class=\"col-lg-12\"><h3>" + data.stay.hotel_description);

		function hotelData(rowNumber) {
			$("#stay > .container > .hotels > ." + rowNumber).append("<div class=\"col-lg-4 block" + i + "\">");
		...
		// section title
		$("#transport > .container").append("<div class=\"title row\"><div class=\"col-lg-12\"><h1>" + data.transport.title);
		$("#transport > .container").append("<div class=\"title row\"><div class=\"col-lg-12\"><h4>" + data.transport.description);
		
		$("#transport > .container").append("<div class=\"move\">");

		function moveData(rowNumber) {
			$("#transport > .container > .move > ." + rowNumber).append("<div class=\"col-lg-4 block" + i + "\">");
		...
		// section title
		$("#drink > .container").append("<div class=\"title row\"><div class=\"col-lg-12\"><h1>" + data.drink.title);
		$("#drink > .container").append("<div class=\"title row\"><div class=\"col-lg-12\"><h4>" + data.drink.description);
